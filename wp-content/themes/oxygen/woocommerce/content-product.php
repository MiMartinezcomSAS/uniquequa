			...
			<a href="<?php the_permalink(); ?>" class="thumb">
				...
				if($product_images_urls && $item_preview_type != 'None'):
					...
					foreach($product_images_urls as $attachment_url): 
						...
						$image_src = wp_get_attachment_image_src($product_images_urls_ids[$attachment_url], 'shop-thumb-1');
					
						if($image_src)
						{
							$image_src = $image_src[0];
							
							echo '<img data-src="' . $image_src . '" class="hidden-slowly lab-lazy-load" />';
						}
